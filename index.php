        ...
        <div class="sl-slider">
          ...
          <div class="sl-slide" data-orientation="horizontal" data-slice1-rotation="-25" data-slice2-rotation="-25" data-slice1-scale="2" data-slice2-scale="2">
            <div class="sl-slide-inner">
              ...
              <h2><a href="#">집1번제목</a></h2>
              <blockquote>
              <p class="location"><span class="glyphicon glyphicon-map-marker"></span>한국</p>
              <p>집1번 내용</p>
              <cite>2억</cite>
              </blockquote>
            </div>
          ...
          <div class="sl-slide" data-orientation="vertical" data-slice1-rotation="10" data-slice2-rotation="-15" data-slice1-scale="1.5" data-slice2-scale="1.5">
            <div class="sl-slide-inner">
              ...
              <h2><a href="#">집 2번제목</a></h2>
              <blockquote>
              <p class="location"><span class="glyphicon glyphicon-map-marker"></span> 미국</p>
              <p>집2번내용</p>
              <cite>3억</cite>
              </blockquote>
            </div>
          ...
          <div class="sl-slide" data-orientation="horizontal" data-slice1-rotation="3" data-slice2-rotation="3" data-slice1-scale="2" data-slice2-scale="1">
            <div class="sl-slide-inner">
              ...
              <h2><a href="#">집3번제목</a></h2>
              <blockquote>
              <p class="location"><span class="glyphicon glyphicon-map-marker"></span>호주</p>
              <p>집3번내용</p>
              <cite>5억</cite>
              </blockquote>
            </div>
          ...
          <div class="sl-slide" data-orientation="vertical" data-slice1-rotation="-5" data-slice2-rotation="25" data-slice1-scale="2" data-slice2-scale="1">
            <div class="sl-slide-inner">
              ...
              <h2><a href="#">집4번제목</a></h2>
              <blockquote>
              <p class="location"><span class="glyphicon glyphicon-map-marker"></span>대만</p>
              <p>집4번내용</p>
              <cite>20억</cite>
              </blockquote>
            </div>
          ...
          <div class="sl-slide" data-orientation="horizontal" data-slice1-rotation="-5" data-slice2-rotation="10" data-slice1-scale="2" data-slice2-scale="1">
            <div class="sl-slide-inner">
              ...
              <h2><a href="#">집5번제목</a></h2>
              <blockquote>
              <p class="location"><span class="glyphicon glyphicon-map-marker"></span>제주도</p>
              <p>집5번내용</p>
              <cite>7억</cite>
              </blockquote>
            </div>
  ...
  <div class="properties-listing spacer"> <a href="buysalerent.php" class="pull-right viewall">View All Listing</a>
    ...
    <div id="owl-example" class="owl-carousel">
      <div class="properties">
        ...
        <h4><a href="property-detail.php">이인우</a></h4>
        <p class="price">가격 : 3억</p>
        <div class="listing-detail"><span data-toggle="tooltip" data-placement="bottom" data-original-title="Bed Room">5</span> <span data-toggle="tooltip" data-placement="bottom" data-original-title="Living Room">2</span> <span data-toggle="tooltip" data-placement="bottom" data-original-title="Parking">2</span> <span data-toggle="tooltip" data-placement="bottom" data-original-title="Kitchen">1</span> </div>
        <a class="btn btn-primary" href="property-detail.php">세부사항</a>
      </div>
      <div class="properties">
  ...
  <div class="spacer">
    <div class="row">
      <div class="col-lg-6 col-sm-9 recent-view">
        <h3>About Us</h3>
        <p>저희는 집팔고있어요<br><a href="about.php">더보기</a></p>
            ...
            <div class="item active">
              <div class="row">
                ...
                <div class="col-lg-8">
                  ...
                  <a href="property-detail.php" class="more">세부사항</a> </div>
              </div>
            </div>
            <div class="item">
              <div class="row">
